...
const navigation = {
  main: [
    { name: "Le club", href: "/club", current: false },
    { name: "Infos sportives", href: "/sports_infos", current: false },
    { name: "Infos Pratiques", href: "/utils_infos", current: false },
    { name: "La boutique", href: "/store", current: false },
  ],
  social: [
    {
      name: "Facebook",
